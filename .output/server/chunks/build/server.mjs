...
const _routes = [
  {
    ...
    component: () => import('./index-C_LhL1bR.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "script",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/script",
    meta: __nuxt_page_meta || {},
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: __nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect,
    component: () => import('./script-D5u6OIT6.mjs').then((m) => m.default || m)
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "centered-layout" }, _attrs))}>`);
